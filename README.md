# ML-тестирование с помощью React
...
**Список вопросов** представлен в файле `questions.js`  

**Основной скрипт** представлен в файле `ml_quiz.js`  

**Стили** представлены в файле `styles.css`  
